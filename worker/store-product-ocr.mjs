...
title 是商品名稱；description 僅整理可確認的規格、內容、單位與促銷條件，保留換行，最多 2000 字。
price_cents 是單件商品明確的新台幣價格乘以 100。原價與單一明確售價並列時使用售價，條件寫入說明。多規格、多價、起價、會員／限時／組合／滿額條件不明、非新台幣或看不清楚時填 null，price_note 解釋需人工確認；不可把電話、日期或折扣百分比當價格。沒有標價也填 null，不可填 0 代替。
