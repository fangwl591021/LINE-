...
ok(worker.includes("if (/^(https?|mailto|line):/i.test(value)) return value;") && worker.includes("if (/^tel:/i.test(value))"), 'worker preserves safe schemes and normalizes tel values');
