...
ok(/'name','industry','gender','phone','birthday','region','address','socials','store_id','tg_token','tg_chat_id'\]\.forEach\(key => \{\s*user\[key\] = existing\[key\] \|\| '';/.test(worker), 'upsertUser preserves hard admin personal fields');
