...
if (!/js\/navigation\.js\?v=(?:7\.(?:9\d*)|8\.0[0-3])/.test(index) ||
...
[
  ...
  'buildHomeAiAssistantHealth_',
  'resolveHomeAiAssistantOwnCards_',
  'window.subsiteHomeFastData?.cards?.ownCard',
  'isAuthoritative',
  'window.homeAiAssistantHealth',
  ...
  "health.fateTagCount === 5 && health.businessIntentCount === 3",
  'window.openHomeFateTags',
  "myCard: '我的名片'",
  ...
  'ensureHomeAiFortuneMatches_',
  "window.fetchAPI('matchmakeContacts'",
  "primaryScope = health.collectedCardCount > 0 ? 'own' : 'public'",
  "requestHomeAiFortuneMatches_('public'",
  'combined.slice(0, 3)',
  "preferredAction: 'fortuneMatches'",
  "advice.action === 'fortuneMatches'",
  '查看今日 3 位推薦',
  'window.homeAiFortuneMatches',
