...
ok(adapter.includes("['社群LINE','LINE 網址']")&&adapter.includes("['社群Instagram','Instagram 網址']")&&adapter.includes("['社群Facebook','Facebook 網址']"),'social contacts are reviewed in separate fields');
