...
| 起始 commit | af539a8 |
| 預計修改檔案 | auth、home、index、兩個 cache-bust contracts、本工作單 |
...
| 修改後正式頁 Network/trace | PENDING | GitHub Pages 發佈後執行 |
...
結論：可部署 GitHub Pages；發佈後必須驗證 cache-bust、首頁登入與 Network 請求數。