...
test('cache versions and private entry are wired without eager directory loading',()=>{
  ...
  assert.match(html,/core\.js\?v=7\.33/);assert.match(html,/store-shop-entry\.js\?v=35/);
  for(const source of [entry,publicPage]){assert.match(source,/store-shop\.css\?v=24/);assert.match(source,/store-shop\.js\?v=33/);}
