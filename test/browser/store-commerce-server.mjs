...
for(const file of ['0029_store_shop_catalog.sql','0030_store_cashier_requests.sql','0031_store_product_category.sql','0034_store_commerce.sql','0035_store_product_purchase_mode.sql','0036_store_product_ocr_usage.sql','0037_store_buyer_profiles.sql','0038_store_buyer_delivery.sql'])sql.exec(readFileSync(new URL('../../migrations/'+file,import.meta.url),'utf8'));
