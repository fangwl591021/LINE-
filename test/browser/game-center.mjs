...
try{
 ...
 await page.goto(origin);await until(()=>typeof openGameCenter==='function'&&typeof startDailyTankChallenge==='function');await open();assert.equal(await page.locator('.gc-cards article').count(),2);await shot('lobby-mobile');
